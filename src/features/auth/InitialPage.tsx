  ...
  return (
    <div className="relative w-screen h-[100dvh] bg-[#F5F1E3] flex flex-col overflow-hidden font-sans">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-5 pt-16">
        ...
        {/* Wordmark — same teal as icon per Figma CSS */}
        ...
        <p
          ...
          className="text-[16px] text-[#304D6D] text-center mt-4 mb-0 max-w-[280px] leading-[24px]"
        >
      ...
      {/* Legal footer — sits naturally at the bottom of the flex column */}
      <footer className="w-full flex justify-between px-5 pb-5 pointer-events-none shrink-0" style={{ fontFamily: "'Inter', sans-serif" }}>
        {[
