 ...
 */
function buildConstraintsLayer() {
...
export function buildUserPrompt(context) {
    ...
    const paceDesc = travelPace === 'relaxed' ? 'relaxed pace (time to settle, explore deeply)' : travelPace === 'active' ? 'active pace (pack in experiences)' : 'balanced pace (mix of activities and rest)';
